...
import type { BlogDetailResponse, BlogPostDetail, BlogTagData } from "@/common/api-types";
...
async function getPost(slug: string): Promise<BlogPostDetail | null> {
  try {
    const data = await backendFetch<BlogDetailResponse>(`/api/blog/${encodeURIComponent(slug)}`);
