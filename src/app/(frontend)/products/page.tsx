...
import type { ProductCardData, ProductListResponse, SettingsResponse } from "@/common/api-types";
...
async function getCatalogueUrl() {
  try {
    ...
    return data.settings?.product_catalogue_url || DEFAULT_CATALOGUE_URL;
  } catch {
